...
class Report(db.Model, SerializerMixin):
    ...
    def __repr__(self):
        return f"<Report(id={self.id}, status='{self.status}', user_id={self.user_id}, date='{self.created_at.strftime('%Y-%m-%d')}')>"
...
class ImageUrl(db.Model, SerializerMixin):
    ...
    def __repr__(self):
        return f"<ImageUrl(id={self.id}, report_id={self.incident_report_id}, media_image='{self.media_image[:20]}...')>"
...
class VideoUrl(db.Model, SerializerMixin):
    ...
    def __repr__(self):
        return f"<VideoUrl(id={self.id}, report_id={self.incident_report_id}, media_video='{self.media_video[:20]}...')>"
...
class EmergencyReport(db.Model, SerializerMixin):
    ...
    def __repr__(self):
        return f"<EmergencyReport(id={self.id}, name='{self.name}', status='{self.status}', phone='{self.phone}')>"
...
class Notification(db.Model, SerializerMixin):
    ...
    def __repr__(self):
        return f"<Notification(id={self.id}, message='{self.message[:20]}...', read={self.read})>"
